...
import com.example.creditcardexpenses.presentation.components.screens.transactionCard.editTransactionCard.component.EditTransactionDetail

@Composable
fun EditTransactionCardScreen(navController: NavHostController, vm: EditTransactionCardViewModel = hiltViewModel()) {
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier.padding()) {
            ...
            EditTransactionDetail(navController, vm)
        }
    }
}
